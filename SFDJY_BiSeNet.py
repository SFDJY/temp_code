...
class ContextPath(nn.Module):
    ...
    def forward(self, x):
        ...
        up_feature_x32 = F.interpolate(center, scale_factor=(self.input_size // 32), mode='bilinear',
                                       align_corners=False)
...
class BiSeNet(nn.Module):
    ...
    def __init__(self, input_size=256, class_num=6):
        super().__init__()
    ...
    def forward(self, x):
        ...
        return F.interpolate(seg, scale_factor=8, mode='bilinear', align_corners=False)
